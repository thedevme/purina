...
@interface AddContactViewController_iPhone5 : UIViewController  <UITextFieldDelegate, TTTAttributedLabelDelegate, FindContactDelegate, FindContactViewDelegate>
