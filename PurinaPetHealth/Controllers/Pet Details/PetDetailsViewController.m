...
@interface PetDetailsViewController ()
...
{
    AddPetViewController* addPetViewController = [[AddPetViewController alloc] initWithNibName:@"AddPetViewController" bundle:nil];
...
- (void)showAppointments
{
    ...
    [Flurry logEvent:@"00_NES_42646_PetHealthUD_IOS_SHOWAPPTS"];
}
...
- (void)showMedical
{
    ...
    [Flurry logEvent:@"00_NES_42646_PetHealthUD_IOS_SHOWMEDICAL"];
}
...
- (void) showIdentification
{
    ...
    [Flurry logEvent:@"00_NES_42646_PetHealthUD_IOS_SHOWIDENTIFICATION"];
}
...
- (void) addNewContact:(NSNotification *)note
{
    ...
    navController.navigationBar.barStyle = UIBarStyleBlackOpaque;
    [self presentModalViewController:navController animated:YES];
    [Flurry logEvent:@"00_NES_42646_PetHealthUD_IOS_ADDNEWCONTACT"];
}
