//
//  BlockActionSheetLandscape.m
//
//

#import "BlockActionSheetLandscape.h"
#import "BlockBackgroundLandscape.h"
#import "BlockUI.h"

@implementation BlockActionSheetLandscape
...
+ (void)initialize   
{
    if (self == [BlockActionSheetLandscape class])
    {
...
{
    return [[[BlockActionSheetLandscape alloc] initWithTitle:title] autorelease];
}
...
- (void)showInView:(UIView *)view
{
    ...
    frame.origin.y = [BlockBackgroundLandscape sharedInstance].bounds.size.height;
