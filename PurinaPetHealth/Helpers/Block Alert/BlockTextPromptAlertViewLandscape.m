//
//  BlockTextPromptAlertViewLandscape.m
//  BlockAlertsDemo
//
...
#import "BlockTextPromptAlertViewLandscape.h"
...
@interface BlockTextPromptAlertViewLandscape ()
@property(nonatomic, copy) TextFieldReturnCallBack callBack;
@end

@implementation BlockTextPromptAlertViewLandscape
...
+ (BlockTextPromptAlertViewLandscape *)promptWithTitle:(NSString *)title message:(NSString *)message defaultText:(NSString*)defaultText block:(TextFieldReturnCallBack)block {
    return [[[BlockTextPromptAlertViewLandscape alloc] initWithTitle:title message:message defaultText:defaultText block:block] autorelease];
}
...
+ (BlockTextPromptAlertViewLandscape *)promptWithTitle:(NSString *)title message:(NSString *)message textField:(out UITextField**)textField block:(TextFieldReturnCallBack) block{
    BlockTextPromptAlertViewLandscape *prompt = [[[BlockTextPromptAlertViewLandscape alloc] initWithTitle:title message:message defaultText:nil block:block] autorelease];
