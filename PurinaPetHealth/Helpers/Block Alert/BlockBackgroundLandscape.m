...
@implementation BlockBackgroundLandscape

@synthesize backgroundImage = _backgroundImage;
@synthesize vignetteBackground = _vignetteBackground;

static BlockBackgroundLandscape *_sharedInstance = nil;
...
+ (id)allocWithZone:(NSZone*)zone
{
    ...
    NSAssert(NO, @ "[BlockBackgroundLandscape alloc] explicitly called on singleton class.");
    return nil;
}
