...
- (id)initWithFormFieldStyle:(IBAFormFieldStyle *)style reuseIdentifier:(NSString *)reuseIdentifier {
    if ((self = [super initWithFormFieldStyle:style reuseIdentifier:reuseIdentifier])) {
		switchControl_ = [[DCRoundSwitch alloc] init];
		[self.cellView addSubview:switchControl_];
        
        
//        ((UILabel *)[[[[[[switchControl_ subviews] lastObject] subviews] objectAtIndex:2] subviews] objectAtIndex:0]).text = @"YES";
//        ((UILabel *)[[[[[[switchControl_ subviews] lastObject] subviews] objectAtIndex:2] subviews] objectAtIndex:1]).text = @"NO";

        switchControl_.onText = NSLocalizedString(@"YES", nil);
        switchControl_.offText = NSLocalizedString(@"NO", nil);
